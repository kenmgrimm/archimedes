...
test_entities = [
  ...
  { type: 'Asset', name: 'Laptop', properties: { 'serial_number' => 'GENERIC123', 'category' => 'electronics', 'make' => 'GenericBrand', 'model' => 'Alpha' } },
  { type: 'Asset', name: 'Work Laptop', properties: { 'serial_number' => 'GENERIC123', 'category' => 'electronics', 'make' => 'GenericBrand', 'model' => 'Alpha' } },
  ...
  { type: 'Document', name: 'Project Plan', properties: { 'title' => 'Project Plan', 'description' => 'Initial project planning document', 'content' => 'Full text of plan.' } },
  { type: 'Document', name: 'Project Plan v2', properties: { 'title' => 'Project Plan', 'description' => 'Updated plan', 'content' => 'Full text of plan.' } },
